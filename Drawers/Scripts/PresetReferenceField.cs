...
public class PresetReferenceField : InspectorField, IDropHandler
{
...
#pragma warning restore 0649
	...
	{
		foreach (Type t in PresetLibrary.GetTypes())
	...
	{
		PresetLibraryUI.Instance.OnPresetSelected += preset => OnReferenceChanged(preset.GetPresetReference());
		PresetLibraryUI.Instance.Show("", PresetTags.None, BoundVariableType);
